                    ...
                    <div class="modal-footer py-0">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 margin-bottom-8px">
                                <x-backend.button.save type="submit" :label="__('Create')" class="py-2 ltr:ms-2 ltr:float-right rtl:me-2 rtl:float-left" />
                ...
                <form action="{{ route('blog.category.update') }}" method="post" id="edit-payment-form"
                    ...
                    <div class="modal-footer py-0">
                        <div class="form-group row">
                            <label for="btn_save" class="col-sm-3 control-label"></label>
                            <div class="col-sm-12 margin-bottom-8px">
                                <x-backend.button.save type="submit" :label="__('Update')" class="py-2 {{ languageDirection() == 'ltr' ? 'ms-2 float-right' : 'me-2 float-left' }}" />
                                <x-backend.button.cancel dismiss :label="__('Close')" class="py-2 {{ languageDirection() == 'ltr' ? 'float-right' : 'float-left' }}" />
                            </div>
                        </div>
                    </div>
                </form>
