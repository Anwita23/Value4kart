<div class="col-sm-12">
    ...
    <div class="col-sm-10 px-0 mt-3 mt-md-0">
        <div class="w-100 admin-form-actions">
            <x-backend.button.cancel :href="isset($userType) && $userType == 'admin' ? route('purchase.index') : route('vendor.purchase.index')" :label="__('Cancel')" class="all-cancel-btn" />
            <x-backend.button.save
                type="submit"
                id="btnSubmit"
                :label="__('Update')"
                :disabled="$purchaseDetails->status === 'Received'"
            >
