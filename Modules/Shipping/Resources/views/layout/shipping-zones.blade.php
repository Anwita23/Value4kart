...
<div class="row px-4">
    <div class="col-sm-12 p-0 mt-14 accordion-parent">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="10" class="pt-3">
                                        <x-backend.button.save type="button" :label="__('Add New Location')" class="btn-sm add-new-location" />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
        ...
        <div class="mt-14">
            <x-backend.button.save type="button" :label="__('Add New')" class="add-shipping-zone" />
            <x-backend.button.save type="submit" :label="__('Save')" class="save-shipping-zone" />
        </div>
    </div>
</div>
