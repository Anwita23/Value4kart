                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="10" class="pt-3">
                            <x-backend.button.save type="button" data-id="1" :label="__('Add New')" class="add-new-class add-btn" />
                            <x-backend.button.save type="submit" data-id="1" :label="__('Save')" class="save-class" />
                        </td>
                    </tr>
                </tbody>
            </table>
