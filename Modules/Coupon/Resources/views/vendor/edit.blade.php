                                    ...
                                    <div class="tab-pane fade" id="v-pills-general" role="tabpanel"
                                        ...
                                        <div class="modal-footer py-0">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <x-backend.button.save type="button" data-id="v-pills-restriction-tab" :label="__('Next')" class="form-submit ltr:float-right rtl:float-left switch-tab" />
                                                    <x-backend.button.save type="button" :label="__('Previous')" class="form-submit ltr:float-right rtl:float-left mx-2" disabled />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="w-100 admin-form-actions">
                                                        <x-backend.button.cancel :href="route('vendor.coupons')" :label="__('Cancel')" class="py-2 form-submit ltr:float-right coupon-submit-button all-cancel-btn" />
