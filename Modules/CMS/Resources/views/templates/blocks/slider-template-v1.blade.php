...
@endphp
<section class="{{ $component->full == 1 ? 'layout-wrapper px-4 xl:px-0' : 'layout-wrapper px-4 xl:px-0' }} md:my-12 my-10 overflow-hidden"
                ...
                @foreach ($slides as $slide)
                    <div class="swiper-slide">
                        <div class="relative w-full" style="line-height:0;">
                            {{-- Banner image — defines the slide height --}}
                            <img class="other-slider-images {{ $component->rounded == 1 ? 'rounded-lg' : '' }} w-full block"
                                style="height: {{$component->height . 'px'}}; --slider-height:{{$component->height . 'px'}}; object-fit: cover; object-position: center;"
                                src="{{ $slide->fileUrlQuery() }}" alt="{{ strip_tags($slide->title_text) }}">

                            {{-- Text overlay — absolutely positioned on top of the image --}}
                            <div class="costume-title w-full absolute inset-0 flex items-center" style="line-height:normal;">
                                <div class="{{ $component->full == 1 ? 'layout-wrapper px-4 xl:px-0' : 'px-5 sm:px-11' }} w-full">
