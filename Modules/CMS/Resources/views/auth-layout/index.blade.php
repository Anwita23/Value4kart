                ...
                <form action="{{ route('auth.layout.store') }}" method="post" class="product_setting_form" enctype="multipart/form-data">
                    ...
                    <div class="card-footer p-0">
                        <div class="w-100 admin-form-actions">
                            <x-backend.button.cancel :href="url('auth/login') . '?template=' . preference('auth_template_name', 'template-1')" :label="''" class="all-cancel-btn ltr:float-right rtl:float-left px-3 me-0 preview-button" target="_blank">
                                <span class="fa fa-eye">&nbsp;</span>{{ __('Preview') }}
