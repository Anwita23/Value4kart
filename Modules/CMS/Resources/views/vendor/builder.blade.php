...
@section('content')
        ...
        <div class="card">
            ...
            <div class="card-footer py-3 d-flex justify-content-end">
                <div class="form-group d-flex mb-0">
                    <x-backend.button.save type="submit" id="update_page" :label="__('Save')" class="btn-sm has-spinner-loader mb-0">
                        <i class="feather icon-save ltr:me-1 rtl:ms-1"></i>
    ...
    <x-backend.delete-modal :cmsSectionBuilder="true" :includeBatchDelete="false" :includeScript="false" />
@endsection
