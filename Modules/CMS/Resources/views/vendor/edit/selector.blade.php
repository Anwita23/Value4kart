        ...
        <div class="card-body">
            <form action="{{ route('vendor.builder.form', ['file' => '__file']) }}" method="post" id="layout_selector"
                ...
                <div class="form-group d-flex">
                    <x-backend.button.save type="submit" id="layout_select" :label="''"
                        class="custom-btn-small ltr:float-right rtl:float-left"
                        data-url="{{ route('vendor.builder.form', ['file' => 'layout_1']) }}" data-layout="0">
                        {{ __('Select') }}
