@php
    $query = array_merge($component->query ?? [], [
        'channel' => \App\Enums\ProductChannel::$Store,
        'vendor_id' => $component->page()->first()?->vendor_id,
    ]);
    
    $products = $homeService->getProducts($component->showcase_type, $component->total_products, $query);
