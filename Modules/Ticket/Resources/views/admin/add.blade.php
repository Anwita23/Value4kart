...
<x-backend.button.cancel :href="route('admin.tickets')" :label="__('Cancel')" class="py-2" />
                                            <x-backend.button.save type="submit" id="add_ticket_btn" :label="''" class="py-2 ltr:ms-1 rtl:me-1">
