        ...
        <form id="addons-form-container" action="{{ route('addon.upload') }}" method="post" class="addons-form"
            ...
            <div class="form-align">
                ...
                <div class="input-file-container w-100">
                    <div class="addons-form-actions py-3">
                        <x-backend.button.cancel type="button" id="cancel-addform" :label="__('Cancel')" class="all-cancel-btn" />
                        <x-backend.button.save type="submit" :label="__('Upload Now')" />
                    </div>
                </div>
            </div>
        </form>
