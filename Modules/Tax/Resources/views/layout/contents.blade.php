                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="10" class="pt-3">
                                    <x-backend.button.save type="button" data-id="{{ $tax->id }}" :label="__('Add New')" class="btn-sm add-btn" />
                                    @if ($tax->taxRates->count())
                                        <x-backend.button.save type="submit" :data-id="$tax->id" :label="__('Save')" class="btn-sm update-btn" />
                                    @endif
                                </td>
                            </tr>
                        </tbody>
