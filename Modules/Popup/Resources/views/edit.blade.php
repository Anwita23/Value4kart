                                            ...
                                            <div class="modal-footer">
                                                <div class="form-group md-row">
                                                    ...
                                                    <div class="col-md-12 d-flex">
                                                        <x-backend.button.save type="button" :label="__('Previous')" class="form-submit ltr:float-right rtl:float-left me-2" disabled />
                                                        <x-backend.button.save type="button" data-id="v-pills-display-tab" :label="__('Next')" class="form-submit ltr:float-right rtl:float-left switch-tab" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-display" role="tabpanel"
                                            ...
                                            <div class="modal-footer">
                                                <div class="form-group md-row">
                                                    <label for="btn_save" class="col-md-3 control-label"></label>
                                                    <div class="col-md-12 d-flex">
                                                        <x-backend.button.save type="button" data-id="v-pills-general-tab" :label="__('Previous')" class="form-submit ltr:float-right rtl:float-left switch-tab me-2" />
                                                        <x-backend.button.save type="button" data-id="v-pills-content-tab" :label="__('Next')" class="form-submit ltr:float-right rtl:float-left switch-tab" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-content" role="tabpanel"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-10 mt-14 mb-3 px-0 w-full">
                                                        <x-backend.button.save type="button" class="form-submit" data-id="{{ isset($textIteration) ? $textIteration + 1 : 2 }}" id="add_text" :label="__('Add text')" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal-footer">
                                                <div class="form-group md-row">
                                                    <label for="btn_save" class="col-md-3 control-label"></label>
                                                    <div class="col-md-12 d-flex">
                                                        <x-backend.button.save type="button" data-id="v-pills-display-tab" :label="__('Previous')" class="form-submit ltr:float-right rtl:float-left switch-tab me-2" />
                                                        <x-backend.button.save type="button" data-id="{{ empty($popup->type) ? 'v-pills-setting-tab' : 'v-pills-popupType-tab' }}" :label="__('Next')" class="form-submit ltr:float-right rtl:float-left switch-tab" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<x-backend.button.cancel :href="route('popup.index')" :label="__('Cancel')" class="form-submit all-cancel-btn ltr:float-right rtl:float-left coupon-submit-button" />
                                                        <x-backend.button.save type="submit" id="footer-btn" :label="__('Save')" class="form-submit ltr:float-right rtl:float-left popup-store-button" />                                                        </div>
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="modal-footer">
                                                        <div class="form-group md-row">
                                                            <label for="btn_save" class="col-md-3 control-label"></label>
                                                            <div class="col-md-12 d-flex">
                                                                <x-backend.button.save type="button" data-id="v-pills-content-tab" :label="__('Previous')" class="form-submit ltr:float-right rtl:float-left switch-tab me-2" />
                                                                <x-backend.button.save type="button" data-id="v-pills-setting-tab" :label="__('Next')" class="form-submit ltr:float-right rtl:float-left switch-tab" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
