        ...
        <div class="card">
            ...
            <div class="card-block table-border-style">
                <div class="row form-tabs">
                    <form action="{{ route('vendor.attribute.store') }}" method="post" id="attributeForm" class="form-horizontal col-sm-12" enctype="multipart/form-data">
                        @csrf
...
<x-backend.button.cancel :href="route('vendor.attribute.index')" :label="__('Cancel')" class="all-cancel-btn" />
