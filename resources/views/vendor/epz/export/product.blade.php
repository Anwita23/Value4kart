                        ...
                        <form class="col-12" accept="{{ route('epz.export.products') }}" method="POST">
                            ...
                            <div class="col-sm-10">
                                <div class="row mx-2 my-3">
                                    ...
                                    <div class="col-sm-5">
                                        <x-backend.button.save type="submit" id="export" :label="''" class="py-2 mt-3 me-0 float-right">{{ __('Export') }} <i class="feather icon-upload-cloud m-0 ms-2"></i></x-backend.button.save>
                                    </div>
                                </div>
                            </div>
                        </form>
