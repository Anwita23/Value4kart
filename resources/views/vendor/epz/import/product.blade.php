                    ...
                    <div
                        ...
                        @if (!isset($step) || $step == 1)
                            ...
                            <form class="col-12" accept="{{ route('vendor.epz.import.products') }}"
                                ...
                                <x-backend.button.save type="submit" :label="''" class="py-2 ltr:float-right rtl:float-left">{{ __('Next') }}<i class="feather icon-arrow-right"></i></x-backend.button.save>
                            </form>
                        @elseif ($step == 2)
                            ...
                            <form class="col-12 px-3" accept="{{ route('vendor.epz.import.products') }}"
                                ...
                                @endforeach
                                <x-backend.button.save type="submit" :label="''" class="py-2 mt-3 ltr:me-0 ltr:float-right rtl:ms-0 rtl:float-left">{{ __('Import') }} <i class="feather icon-upload-cloud m-0 ltr:ms-2 rtl:me-2"></i></x-backend.button.save>
                            </form>
                        @elseif ($step == 3)
