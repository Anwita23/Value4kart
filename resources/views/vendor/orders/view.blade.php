        ...
        <div class="modal fade" id="delete_modal" tabindex="-1" role="dialog" aria-labelledby="delete_modal_label" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('vendor.order.customize') }}" method="POST" id="order-delete-fee-coupon-form">
                        @csrf
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('site.orderRefund') }}" method="post" class="form-horizontal">
                            ...
                            <div class="form-group row mt-3 mt-md-0">
                                <div class="col-sm-12">
                                    <x-backend.button.save type="submit" :label="__('Submit')" class="float-right" />
                                    <x-backend.button.cancel dismiss :label="__('Close')" class="all-cancel-btn float-right" data-dismiss="modal" />
                                </div>
                            </div>
                        </form>
                    </div>
...
@section('js')
    ...
    <script src="{{ asset('dist/js/custom/order.min.js?v=4.1') }}"></script>
