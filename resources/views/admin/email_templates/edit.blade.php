            ...
            <div class="card-body row">
                ...
                <div class="col-lg-9 col-12 ltr:ps-0 rtl:pe-0">
                    <div class="card card-info shadow-none mb-0">
                                        ...
                                        <div class="col-sm-12 tab-content shadow-none" id="myTabContent">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" placeholder="{{ __('Slug') }}"
                                                                    class="form-control inputFieldDesign bg-light" id="slug"
                                                                    name="slug" required pattern="^[a-zA-Z\-]*$"
                                                                    oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')"
                                                                    data-pattern="{{ __('Only alphabet and white space are allowed.') }}"
                                                                    value="{{ !empty(old('slug')) ? old('slug') : $template->slug }}" readonly>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="text-right w-100 pr-1 mx-0 pt-2">
                                                                ...
                                                                <button type="button"
                                                                    class="btn btn-light btn-small previewButton"
                                                                    id="body-fullscreen-btn"><span class="fa fa-expand"></span> {{ __('Full screen') }}</button>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <input type="hidden" name="variables" value="{{ !empty(old('variables')) ? old('variables') : $template->variables }}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12 px-0 mt-3">
                                                <div class="w-100 admin-form-actions">
                                                    <x-backend.button.cancel :href="route('emailTemplates.index')" :label="__('Cancel')" class="all-cancel-btn" />
                        ...
                        <div id="body-editor-fullscreen-overlay" class="d-none body-editor-fullscreen-overlay">
                            <div class="body-editor-fullscreen-header">
                                <button type="button" class="btn btn-secondary btn-small" id="body-fullscreen-exit"><span class="fa fa-compress"></span> {{ __('Exit full screen') }}</button>
                            </div>
                            <div id="body-editor-fullscreen-inner" class="body-editor-fullscreen-inner"></div>
                        </div>
                    </div>
                </div>
            </div>
