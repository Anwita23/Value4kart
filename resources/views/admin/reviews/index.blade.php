        ...
        <div class="card">
            <div class="card-header bb-none pb-0">
                ...
                <div class="card-header-right my-2 mx-md-0 mx-sm-4">
                    @hasPermission('App\Http\Controllers\ReviewController@destroy')
                        ...
                        <form action="{{ route('review.update') }}" method="post" id="editLanguage" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="modal-footer py-2 py-md-0">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <x-backend.button.save type="submit" :label="__('Update')" class="py-2 ltr:float-right ltr:ms-2 rtl:float-left rtl:me-2" />
