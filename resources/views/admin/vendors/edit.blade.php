...
<x-backend.button.cancel :href="request('shop') ? route('shop.index') : route('vendors.index')" :label="__('Cancel')" class="all-cancel-btn" />
...
@section('js')
    ...
    <script src="{{ asset('dist/js/custom/vendors.min.js?v=3.3') }}"></script>
