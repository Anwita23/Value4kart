                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <form action='{{ route('users.update', ['id' => $user->id]) }}' method="post"
                                ...
                                <div class="w-100 admin-form-actions">
                                        <x-backend.button.cancel :href="route('users.index')" :label="__('Cancel')" class="all-cancel-btn" />
                                        <x-backend.button.save id="btnSubmit" :label="__('Update')" />
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <form action='{{ route('users.password', ['id' => $user->id]) }}'
                                        ...
                                        <div class="w-100 admin-form-actions">
                                            <x-backend.button.save id="btnSubmit1" :label="__('Update')" class="admin-password-update" />
                                        </div>
                                    </form>
                                </div>
                            </div>
