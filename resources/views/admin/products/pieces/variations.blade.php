                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="tooltips ltr:ms-2 rtl:me-2 mt-px cursor-pointer">
                                    ...
                                    <span
                                        class="tooltiptexts">{{ __('Send notification to the vendor of the product if stock reaches to this limit.') }}</span>
                                </div>
                            </div>
...
<div class="d-flex mt-20p px-6p pb-19p">
    <x-backend.button.save type="button" class="save_variations" :label="__('Save Changes')" />
</div>
