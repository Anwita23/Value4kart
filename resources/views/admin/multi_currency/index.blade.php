                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="post" id="currency_form" class="form-horizontal">
                                                ...
                                                <div class="modal-footer justify-content-between bg-light-gray">
                                                    <x-backend.button.cancel dismiss :label="__('Cancel')" class="py-2 ltr:float-right ltr:me-2 rtl:float-left rtl:ms-2 text-c-red" />
                                                    <x-backend.button.save type="submit" :label="__('Save')" class="py-2 ltr:float-right rtl:float-left" />
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="card-body table-border-style p-0">
                                                        ...
                                                        <div class="card-footer p-0">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <x-backend.button.save type="submit" id="footer-btn" :label="__('Save')" class="form-submit ltr:float-right rtl:float-left save-button">
...
@section('js')
    ...
    <script src="{{ asset('dist/js/custom/multi_currency.min.js') }}"></script>
@endsection
