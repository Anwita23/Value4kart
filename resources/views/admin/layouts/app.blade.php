...
<head>
    ...
    <!-- Prevent browser from caching admin pages (back button fix) -->
    ...
    <link rel="stylesheet" href="{{ asset('dist/css/custom.min.css?v=' . config('martvill.file_version')) }}">
...
<body <?php echo apply_filters('admin_panel_body_tag', ''); ?>>
    ...
    <!-- Required Js -->
    <script src="{{ asset('datta-able/js/pcoded.min.js?v=2.8') }}"></script>
    <script src="{{ asset('datta-able/plugins/select2/js/select2.full.min.js') }}"></script>
    <script src="{{ asset('dist/js/custom/app-layout.min.js?v=3.3') }}"></script>
    ...
    {{-- Back-button / bfcache fix: if page is restored from browser cache after logout, force reload so server re-validates session --}}
    <script>
