                    ...
                    <form action="{{ route('currency.store') }}" method="post" id="addCurrency" class="form-horizontal">
                        ...
                        <div class="modal-footer py-0">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <x-backend.button.save type="submit" :label="__('Submit')" class="custom-btn-small ltr:float-right rtl:float-left" />
                                    <x-backend.button.cancel dismiss :label="__('Close')" class="custom-btn-small ltr:float-right rtl:float-left" data-dismiss="modal" />
                                </div>
                            </div>
                        </div>
                    </form>
