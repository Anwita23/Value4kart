                            ...
                            <tr>
                                ...
                                <td class="p-3 ltr:text-left rtl:text-right">
                                    <span class="font-medium text-sm text-black whitespace-nowrap">
                                        {{ $item['data']['download_limit'] == '' || $item['data']['download_limit'] == -1 ? __('Unlimited') : $item['data']['download_limit'] - $item['data']['download_times'] }}
                                    </span>
                                </td>
                                <td class="p-3 ltr:text-left rtl:text-right">
                                    <span class="font-medium text-sm text-black whitespace-nowrap">
                                        {{ $item['data']['download_expiry'] == '' ? __('Never') : formatDate($item['order']->created_at->addDays($item['data']['download_expiry'])) }}
                                    </span>
                                </td>
                                <td class="p-3 ltr:text-left rtl:text-right">
                                    <a class="bg-black font-medium text-white px-3 py-1 rounded text-xs leading-5 whitespace-nowrap flex justify-center items-center gap-1 "
                                        href="{{ route('site.downloadProduct',['link' => \Crypt::encrypt($item['data']['link']),'file' => $item['data']['id'].",".$item['order']->id]) }}">
