                                ...
                                <tr>
                                    <td class="px-3 py-4 ltr:text-left rtl:text-right">
                                        <span class="font-medium text-sm text-black whitespace-nowrap">
                                            {{ $activity->properties_array['browser'] ?? '' }}
                                        </span>
                                    </td>
                                    <td class="px-3 py-4 ltr:text-left rtl:text-right">
                                        <span class="font-medium text-sm text-black whitespace-nowrap">
                                            {{ $activity->properties_array['platform'] ?? '' }}
                                        </span>
                                    </td>
                                    <td class="px-3 py-4">
                                        <span class="font-medium text-sm text-black whitespace-nowrap">{{ $activity->properties_array['ip_address'] ?? '' }}</span>
                                    </td>
                                    <td class="px-3 py-4 ltr:text-left rtl:text-right">
                                        <span class="font-medium text-sm text-black whitespace-nowrap">
