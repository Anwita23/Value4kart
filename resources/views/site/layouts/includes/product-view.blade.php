                            ...
                            <div>
                                ...
                                <div class="flex">
                                    @if ($product->isVariableProduct())
                                        ...
                                        @endphp
                                        <span class="text-2.5xl dm-bold text-gray-12" id="varMinMaxPriceV">
                                            @if ($filterVariation['min'] == $filterVariation['max'])
                                                {{ multiCurrencyFormatNumber($filterVariation['min']) }}
                                            @else
                                                {{ multiCurrencyFormatNumber($filterVariation['min']) }} - {{ multiCurrencyFormatNumber($filterVariation['max']) }}
                                            @endif
