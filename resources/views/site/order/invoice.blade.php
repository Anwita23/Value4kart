                    ...
                    <tbody>
                        @foreach ($orderDetailRows as $row)
                            <tr>
                                ...
                                @if ($shop && $invoiceSetting?->document?->product_table?->is_vendor_name)
                                    <td class="td">
                                        <p class="vendor-name">{{ optional($row['detail']->vendor)->name }}</p>
                                    </td>
                                @endif

                                @if ($invoiceSetting?->document?->product_table?->is_quentity)
                                    <td class="td text-center">
                                        <p class="product-details">{{ formatCurrencyAmount($row['detail']->quantity) }}</p>
                                    </td>
                                @endif

                                <td class="td">
                                    <p class="product-details currency_symbol">
                                        {{ formatNumber($row['detail']->price * $row['detail']->quantity, $currency) }}
                                    </p>
                                </td>
                            </tr>
                        @endforeach
