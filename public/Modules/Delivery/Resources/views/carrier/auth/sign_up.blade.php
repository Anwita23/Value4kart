...
@section('page_title', __('Carrier Registration'))
@section('css')
...
@endphp
    ...
    <div class="3xl:mx-470p 2xl:mx-64 xl:mx-32 md:mx-20 mx-5 mb-70p 3xl:-mt-132p -mt-28 relative border border-gray-2 bg-white rounded-lg">
        ...
        <form method="post" action="{{ route('carrier.sign_up.store') }}"
            id="carrierSignUpForm" class="lg:mt-8 mt-30p xl:mx-130p lg:mx-70p mx-15p" onsubmit="return formValidation()" enctype="multipart/form-data">
            @csrf
            @error('name')
                <div class="flex justify-center">
                ...
                <div class="w-full">
                    <div class="flex justify-between">
                        ...
                        <div class="help-tip text-justify relative">
                            <p class="text-11 text-gray-10 roboto-medium font-medium px-3 bottom-2 right-5 py-2 border border-gray-2 rounded bg-gray-25 absolute"> {{ __('Password must be at least :x characters. Contain uppercase and lowercase letters, numbers and special characters.', ['x' => $length]) }}
                            </p>
                        </div>
                    </div>
