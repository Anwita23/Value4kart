...
<x-backend.button.cancel :href="route(isset($isHome) ? 'page.home' : 'page.index')" :label="__('Cancel')" class="py-2 ltr:me-2 rtl:ms-2" />
                                <x-backend.button.save type="submit" id="btnSubmit1" :label="__('Update')" class="page-submit ltr:me-2 rtl:ms-2" />                                </div>
