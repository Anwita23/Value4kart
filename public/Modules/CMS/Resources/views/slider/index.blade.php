                ...
                <form action="{{ route('slider.store') }}" method="post" id="addPaymentForm" class="form-horizontal">
                    ...
                    <div class="modal-footer py-0">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <x-backend.button.save type="submit" :label="__('Create')" class="ltr:float-right rtl:float-left" />
                                <x-backend.button.cancel dismiss :label="__('Close')" class="py-13 float-end ltr:me-2 rtl:ms-2 h4" />
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <form action="{{ route('slider.update') }}" method="post" id="edit-slider-form"
                    ...
                    <div class="modal-footer py-0">
                        <div class="form-group row">
                            <label for="btn_save" class="col-sm-3 control-label f-14"></label>
                            <div class="col-sm-12">
                                <x-backend.button.save type="submit" :label="__('Update')" class="float-end" />
                                <x-backend.button.cancel dismiss :label="__('Close')" class="py-13 float-end h4 ltr:me-2 rtl:ms-2" />
                            </div>
                        </div>
                    </div>
                </form>
