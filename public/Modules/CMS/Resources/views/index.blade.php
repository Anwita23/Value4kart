...
@section('content')
    ...
    <x-backend.delete-modal :includeBatchDelete="false" :includeScript="false" :includeCmsInternalForm="true" />
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="updatePageLabel">{{ __('Update page') }}</h5>
                    ...
                    <div class="modal-footer">
                        <x-backend.button.cancel dismiss :label="__('Close')" class="py-2" />
                        <x-backend.button.save type="submit" :label="__('Update')" class="py-2 has-spinner-loader" />
                    </div>
                </div>
            </div>
        </form>
