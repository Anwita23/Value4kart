...
<div class="h-full flex flex-col bg-white border border-gray-200 transition duration-300 hover:shadow-md relative group rounded-md">
    ...
    {{-- Image & Hover Actions --}}
    <div style="height: {{ empty($component->card_height) ? $isEnableProduct['height'] : $component->card_height }}px" class="relative w-full overflow-hidden flex justify-center items-center p-4 rev-img product-hover">
    ...
    {{-- Content Section --}}
    <div class="p-4 pt-2 flex flex-col flex-grow text-left" id="product-price-div-{{ $item->code }}">
        {{-- Title --}}
