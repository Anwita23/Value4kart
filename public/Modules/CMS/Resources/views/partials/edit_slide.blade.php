                ...
                <div class="tab-pane fade show active" id="v-pills-image-and-button" role="tabpanel" aria-labelledby="v-pills-general-tab">
                    ...
                    <div class="modal-footer py-0 mt-9">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <x-backend.button.save type="button" data-id="v-pills-title-tab" :label="__('Next')" class="form-submit ltr:float-right rtl:float-left switch-tab" />
                ...
                <div class="tab-pane fade" id="v-pills-title" role="tabpanel" aria-labelledby="v-pills-title-tab">
                    ...
                    <div class="modal-footer py-0 mt-9">
                        <div class="form-group row">
                            <label for="btn_save" class="col-sm-3 control-label"></label>
                            <div class="col-sm-12">
                                <x-backend.button.save type="button" data-id="v-pills-sub-title-tab" :label="__('Next')" class="form-submit ltr:float-right rtl:float-left switch-tab" />
                ...
                <div class="tab-pane fade" id="v-pills-sub-title" role="tabpanel" aria-labelledby="v-pills-sub-title-tab">
                    ...
                    <div class="modal-footer py-0 mt-9">
                        <div class="form-group row">
                            <label for="btn_save" class="col-sm-3 control-label"></label>
                            <div class="col-sm-12">
                                <x-backend.button.save type="button" data-id="v-pills-description-tab" :label="__('Next')" class="form-submit ltr:float-right rtl:float-left switch-tab" />
                                <x-backend.button.save type="button" data-id="v-pills-title-tab" :label="__('Previous')" class="form-submit ltr:float-right rtl:float-left switch-tab me-2" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <div class="w-100 admin-form-actions">
                                    <x-backend.button.cancel :href="route('slider.index')" :label="__('Cancel')" class="py-2 form-submit ltr:float-right coupon-submit-button" />
                                    <x-backend.button.save type="submit" id="footer-btn" :label="__('Save')" class="form-submit ltr:float-right rtl:float-left coupon-submit-button" />
                                </div>
                            </div>
                        </div>
                    </div>
