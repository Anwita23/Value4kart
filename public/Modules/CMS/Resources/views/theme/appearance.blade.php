                ...
                <form method="post" id="optionForm" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer appearance py-0">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <x-backend.button.cancel dismiss :label="__('Cancel')" class="theme-option-save-btn" />
                                <x-backend.button.save type="submit" id="footer-btn" :label="__('Save')" class="form-submit ltr:float-right rtl:float-left theme-option-save-btn" />
                            </div>
                        </div>
                    </div>
                </form>
