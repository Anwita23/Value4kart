...
class PageBuilderController extends Controller
{
    ...
    /**
     * Ensure the authenticated user is allowed to edit this page (admin can edit any; vendor only own or site pages).
     */
    private function userCanEditPage(Page $page): bool
    {
        ...
        if ($roleType === 'vendor') {
            $vendorId = $user->vendor()?->vendor_id ?? null;
            if ($vendorId === null) {
                return false;
            }
            return $page->vendor_id === null || (int) $page->vendor_id === (int) $vendorId;
        }
        return false;
    }
}
