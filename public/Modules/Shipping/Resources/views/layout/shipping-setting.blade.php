    ...
    <div class="col-sm-12">
        ...
        <div class="card-footer p-0">
            <div class="form-group row">
                ...
                <div class="col-sm-12">
                    <x-backend.button.save type="submit" id="footer-btn" :label="__('Save')" class="form-submit ltr:float-right rtl:float-left shipping-class-submit shipping-setting-btn" />
                </div>
            </div>
        </div>
    </div>
