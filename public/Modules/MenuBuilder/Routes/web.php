...
Route::group(['prefix' => 'admin', 'namespace' => 'Modules\MenuBuilder\Http\Controllers', 'middleware' => ['auth', 'locale', 'permission', 'web']], function () {
    ...
    Route::get('menu-builder/icons', 'MenuBuilderController@iconSuggestions')->name('menu.icons');
    ...
    Route::post('resolve-route', 'MenuController@resolveRouteFromUrl')->name('menu.resolve-route');
});
