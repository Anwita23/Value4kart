                ...
                <form class="form-horizontal" id="reply_form" action="{{ route('admin.threadReply.store') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 m-t-5" id='reply-btn'>
                            <x-backend.button.save type="submit" id="add_ticket_btn" :label="''" class="btn-reply mr-0 ltr:float-right rtl:float-left">
                                <i class="comment_spinner spinner fa fa-spinner fa-spin custom-btn-small display_none"></i><span id="spinnerText">{{ __('Reply') }} </span>
            ...
            <form method="POST" action="{{ url('admin/update/admin_reply') }}" id="replyModal">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <x-backend.button.cancel dismiss :label="__('Cancel')" class="py-2" />
                        <x-backend.button.save type="submit" :label="__('Update')" class="py-2 ltr:me-2 rtl:ms-2" />
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="modal-dialog">
            <form method="POST" id="cannedForm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <x-backend.button.cancel dismiss :label="__('Cancel')" class="py-2" />
                        <x-backend.button.save type="submit" :label="__('Save')" class="py-2 ltr:me-2 rtl:ms-2" />
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="modal-dialog modal-lg">
            <form method="POST" id="linkForm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <x-backend.button.cancel dismiss :label="__('Cancel')" class="custom-btn-small" />
                        <x-backend.button.save type="submit" :label="__('Save')" class="custom-btn-small" />
                    </div>
                </div>
            </form>
        </div>
