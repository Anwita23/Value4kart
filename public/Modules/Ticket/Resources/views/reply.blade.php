                ...
                <form class="form-horizontal" id="reply_form" action="{{ route('vendor.threadReply.store') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 m-t-5">
                            <x-backend.button.save type="submit" id="btnSubmit" :label="''" class="btn-reply ltr:float-right ltr:me-0 rtl:float-left rtl:ms-0">
            ...
            <form method="POST" action="{{ route('vendor.updateReply') }}" id="replyModal">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <x-backend.button.cancel dismiss :label="__('Cancel')" />
                    </div>
                </div>
            </form>
        </div>
