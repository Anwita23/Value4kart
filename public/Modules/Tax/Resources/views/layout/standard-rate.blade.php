                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="10" class="pt-3">
                                <x-backend.button.save type="button" data-id="1" :label="__('Add New')" class="btn-sm add-btn" />
                                @if ($tax_rates->count())
                                    <x-backend.button.save type="submit" data-id="1" :label="__('Save')" class="btn-sm update-btn" />
                                @endif
                            </td>
                        </tr>
                    </tbody>
