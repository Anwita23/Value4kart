            ...
            <div class="modal-body">
                    <form action="#" method="post" class="form-horizontal col-sm-12" enctype="multipart/form-data" id="locationFrom">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <x-backend.button.save type="submit" id="theLocationModalSubmitBtn" :label="__('Submit')" class="py-2 {{ languageDirection() == 'ltr' ? 'float-right' : 'float-left' }}" />
                                <x-backend.button.cancel dismiss :label="__('Close')" class="py-2 {{ languageDirection() == 'ltr' ? 'float-right me-2' : 'float-left ms-2' }}" />
                            </div>
                        </div>
