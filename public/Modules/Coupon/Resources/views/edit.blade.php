                                        ...
                                        <div class="tab-pane fade" id="v-pills-general" role="tabpanel"
                                            ...
                                            <div class="modal-footer py-0">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <x-backend.button.save type="button" data-id="v-pills-restriction-tab" :label="__('Next')" class="form-submit ltr:float-right rtl:float-left switch-tab mx-2" />
                                                        <x-backend.button.save type="button" :label="__('Previous')" class="form-submit ltr:float-right rtl:float-left" disabled />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-restriction" role="tabpanel"
                                            ...
                                            <div class="modal-footer py-0">
                                                <div class="form-group row">
                                                    <label for="btn_save" class="col-sm-3 control-label"></label>
                                                    <div class="col-sm-12">
                                                        <x-backend.button.save type="button" data-id="v-pills-limit-tab" :label="__('Next')" class="form-submit ltr:float-right rtl:float-left switch-tab mx-2" />
                                                        <x-backend.button.save type="button" data-id="v-pills-general-tab" :label="__('Previous')" class="form-submit ltr:float-right rtl:float-left switch-tab" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="w-100 admin-form-actions">
                                                            <x-backend.button.cancel :href="route('coupon.index')" :label="__('Cancel')" class="py-2 form-submit ltr:float-right coupon-submit-button all-cancel-btn" />
...
@section('js')
    ...
    <script src="{{ asset('dist/js/custom/coupon.min.js?v=3.3') }}"></script>
@endsection
