...
class ProductController extends Controller
{
     ...
     * @return array<string>
     */
    protected static function normalizeProductChannels(array $channels): array
    {
        ...
        if (! empty($rootProduct)) {
            ...
            try {
                ...
                $product = Product::create([
                    ...
                    'channels' => self::normalizeProductChannels($rootProduct->channels ?? []),
    ...
    public function search(Request $request)
    {
        ...
        $query->where(function ($q) {
            $q->whereJsonContains('channels', ProductChannel::$Invoice)
