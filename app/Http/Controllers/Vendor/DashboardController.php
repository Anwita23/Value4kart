...
use App\Services\Vendor\SaasDashboardService;
...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        if (isActive('SaaS')) {
            $saasDashboard = app(SaasDashboardService::class);

            return view('vendor.saas-dashboard', [
                'overviewItems' => $saasDashboard->getSaleOverview(),
                'primaryAnalytics' => $saasDashboard->getPrimaryAnalytics(),
                'performanceData' => $saasDashboard->getPerformanceData(),
                'inventoryPurchase' => $saasDashboard->getInventoryPurchaseData(),
                'recentOrders' => $saasDashboard->getRecentOrders(5),
                'subscription' => $saasDashboard->getSubscriptionData(),
                'defaultCurrency' => Currency::defaultSymbol(),
            ]);
        }
