...
trait ReportHelperTrait
{
     ...
     * @return string
     */
    public function offsetDate($offset = null)
    {
        if ($offset) {
     ...
     * @return string
     */
    public function firstDayOfTheMonth()
    {
        return date('m-01-Y');
    }
     ...
     * @return mixed
     */
    public function complete($data, $key, $returnThis = true)
    {
     ...
     * @return mixed
     */
    public function growthRate($present, $past)
    {
        if (! $present && ! $past) {
            return null;
        } elseif ($past == 0) {
