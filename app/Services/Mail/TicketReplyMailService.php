...
class TicketReplyMailService extends TechVillageMail
{
    ...
    public function send($request)
    {
        ...
        $ticket_reply_url = $isVendor ? 'vendor/ticket/reply/' . base64_encode($request['emailInfo']->id) : 'admin/ticket/reply/' . base64_encode($request['emailInfo']->id);
        $ticket_reply = url($ticket_reply_url);
